...
- **架构参考**：DEWS MOSA参考架构、MOSA遗留系统改造（棕地vs绿地）

#### 实体（13个）
- **人物**：Parth Devang Shah（GWU D.Eng. 2021，MOSA定量评估）
- **政策**：更好采购力3.0（BBP 3.0，2015年MOSA授权）
- **组织**：DoD、The Open Group、NATO、GAO、OMB、INCOSE、DSB、PPI
...
- **项目对比**：SiAW vs AARGM-ER MOSA策略对比、MOSA实施状态矩阵（20项目）
- **工具对比**：Karpathy原版vs实现
