...
AFMC（[[afmc|空军装备司令部]]）数字化物资管理（[[digital-materiel-management|DMM]]）框架的基础设施层由四个核心平台构成：**PLM**（产品生命周期管理）、**FENCES**（联邦网络企业网络安全服务）、**CLOUDONE**（云基础设施）和**PLATFORMONE**（DevSecOps平台）。四者分别覆盖数据管理、网络安全、云基础设施和软件交付四个维度，共同构成[[digital-engineering-ecosystem|DAF数字生态系统]]的基础设施层。
...
- 政府参考架构（[[government-reference-architectures|GRA]]）的79文档→36模型转换需要PLM支撑
...
**与MOSA的关系**：
- MOSA开放接口扩大攻击面——FENCES提供安全保障（[[cybersecurity-vs-mosa-openness|赛博安全与MOSA的张力]]）
...
**与MOSA的关系**：
- 云基础设施是[[digital-engineering-ecosystem|数字工程生态系统]]的技术底座
- 支持GRA模型的分布式访问和协同编辑
- 为MBSE模型库提供存储和计算资源
...
- [[software-defined-capabilities|软件定义能力]]的快速迭代依赖CI/CD流水线
- 模块化组件的独立测试和集成测试
