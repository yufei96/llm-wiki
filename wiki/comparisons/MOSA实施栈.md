...
- 知识库页面：`[[更好购买力3.0]]`、`[[MOSA五支柱]]`、`[[DoDI-5000.85重大能力收购]]`
...
- 知识库页面：`[[FACE技术标准]]`、`[[开放任务系统]]`、`[[C5ISR标准融合]]`
...
- 知识库页面：`[[开放系统架构合同指南V1.1]]`、`[[航空PEO-MOSA实施指南]]`
...
- [[MOSA五支柱]] — 第2层核心文档
- [[C5ISR标准融合]] — 第3层标准趋同
- [[开放系统架构合同指南V1.1]] — 第4层合同指南
- [[PPI数据项描述模板]] — 第5层DID模板
- [[PPI-集成项目管理与系统工程]] — PM-SE整合（层级间协调）
- [[速度与模块化权衡]] — 速度张力（第2层内部矛盾）
