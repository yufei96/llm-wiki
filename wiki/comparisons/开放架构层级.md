...
**NGC2（下一代指挥与控制）**
- **定义域**：陆军地面/航空C2系统
- **核心角色**：陆军平台级C2开放架构，MOSA为技术基础
- **主导方**：美国陆军
- **状态**：RFI阶段（2025年5月SAM.gov发布）
- **概念页**：[[NGC2下一代指挥控制]]
...
- **来源页**：[[NDIA-CFW通用火控ICD2015]]、[[SAM-gov-UAI信息征求]]
...
**混合背板架构（OpenVPX + VNX+）**
- **定义域**：航电机箱硬件集成
- **核心角色**：在同一机箱中集成3U OpenVPX和VNX+标准，为遗留系统提供灵活升级路径
- **主导方**：NAVAIR PMA-209航电架构团队
- **首次展示**：2026年第三届MOSA Defense Summit
- **来源页**：[[NAVAIR第三届MOSA峰会2026]]
...
- **来源页**：[[NAVAIR-OSMP实施指南V1]]、[[军事嵌入-海军OSMP 2025]]

## GRA体系架构模式

[[政府参考架构|政府参考架构（GRA）]]是横跨各层次的架构模式——政府拥有架构定义权，通过标准化接口促进竞争。AFMC的GRA体系（Chris Garrett演示，2024.9）包含：
...
- [[开放任务系统]] — OMS（平台级）
- [[UCS控制站]] — UCS（平台级）
- [[ABMS-GRA先进战斗管理]] — ABMS GRA（平台级）
- [[WOSA武器开放系统架构]] — WOSA（分系统级）
- [[DEWS-MOSA参考架构]] — DEWS RA（分系统级）
- [[NC3-GRA核指挥控制]] — NC3 GRA（分系统级）
- [[Sentinel洲际导弹政府参考架构]] — Sentinel GRA（分系统级）
- [[SOSA传感器开放系统架构]] — SOSA（设备级）
- [[MORA模块化开放射频架构概念]] — MORA（设备级）
- [[AMS-GRA敏捷任务套件]] — AMS GRA（设备级）
- [[A-GRA自主参考架构]] — A-GRA（设备级）
- [[PNT政府参考架构-R-EGI导航]] — PNT GRA/R-EGI（设备级）
- [[COARPS雷达架构]] — COARPS（设备级）
- [[SCARS仿真器架构]] — SCARS（设备级）
- [[FACE技术标准]] — FACE（部组件级）
- [[宿主硬件开放系统]] — HOST（部组件级）

### Source页
- [[DAU下一代采办2024]] — DAU演示（全GRA清单）
- [[空军预备役-A-GRA CCA验证2025]] — A-GRA/CCA验证
- [[CSIS-MOSA责任分担报告2025]] — CSIS AMS GRA/A-GRA分析
- [[CRS-NC3核指挥通信入门]] — NC3 CRS入门
- [[CRS报告-哨兵洲际导弹IF11681]] — Sentinel CRS入门
- [[R-EGI导航飞行测试2024]] — R-EGI飞行演示
- [[空军COARPS信息征求2021]] — COARPS RFI
- [[NTSA-SCARS简报2025]] — SCARS 2025简报
- [[NAVAIR-OSMP实施指南V1]] — OSMP实施指南

### 分析与框架页
- [[政府参考架构]] — GRA架构模式（横跨各层）
- [[C5ISR标准融合]] — C5ISR标准趋同分析
...
- [[SIAW与AARGM-ER模块化对比]] — SiAW vs AARGM-ER对比
- [[XM30 MICV MOSA案例]] — XM-30地面车辆MOSA设计
...
- NGC2是陆军平台级C2系统，处于RFI阶段，标志着陆军从封闭C2向MOSA开放架构转型
- NGC2与空军ABMS GRA、海军OSMP构成三军C2开放架构格局
- VNX+（VITA 74）是小型化VPX变体，与OpenVPX（VITA 46/65）混合使用是海军PMA-209的最新工程实践
- 2026 MOSA Defense Summit上PMA-209演示的混合背板是HOST标准在航电机箱层面的具体实现
