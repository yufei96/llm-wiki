...
SiAW（近距攻击武器）与AARGM-ER（增程型先进反辐射导弹）是同类型空对地/反辐射武器项目，均由 [[诺斯罗普-格鲁曼]] 开发，但MOSA实施状况截然不同：空军SiAW实施MOSA，海军AARGM-ER未实施MOSA。这一对比直接揭示了DoD内部MOSA政策执行不一致问题，是 [[GAO-MOSA专项审查报告全文]] 报告的核心案例之一。
...
- [[开放架构层级]] — 开放架构四层体系总览
- [[诺斯罗普-格鲁曼]] — 两个项目的共同承包商
- [[GAO-MOSA专项审查报告全文]] — GAO MOSA专项审查报告（本对比的原始来源）
