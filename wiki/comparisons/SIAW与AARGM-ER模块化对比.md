...
SiAW（近距攻击武器）与AARGM-ER（增程型先进反辐射导弹）是同类型空对地/反辐射武器项目，均由 [[诺斯罗普-格鲁曼]] 开发，但MOSA实施状况截然不同：空军SiAW实施MOSA，海军AARGM-ER未实施MOSA。这一对比直接揭示了DoD内部MOSA政策执行不一致问题，是 [[GAO-R-25-106931 MOSA审查]] 报告的核心案例之一。
...
**AARGM-ER的非MOSA决策**：海军出于短期采办成本和进度考虑做出决策，未进行正式的MOSA成本效益分析来评估长期效益。此外，AARGM-ER基于现有AARGM导弹改进（棕地项目），而SiAW是全新设计（绿地项目），参见 [[MOSA棕地与绿地对比]]。
...
3. **三军指南不一致** — 陆军有全面指南手册，空军/太空军有部分指南，海军于2024年发布MOSA实施指南V1.0（[[海军MOSA指南V1]]），但GAO-25-106931报告审查时（2025年1月）该指南尚未发布
...
海军于2024年发布MOSA实施指南V1.0（[[海军MOSA指南V1]]），但GAO-25-106931报告审查时（2025年1月）该指南尚未发布。这一差距直接体现在 [[MOSA实施状态矩阵]] 中——海军50%的MOSA实施率远低于陆军的100%。

## 相关内容

- [[开放架构层级]] — 开放架构四层体系总览
- [[诺斯罗普-格鲁曼]] — 两个项目的共同承包商
- [[GAO-R-25-106931 MOSA审查]] — GAO MOSA专项审查报告（本对比的原始来源）
- [[MOSA实施状态矩阵]] — 20项目MOSA实施状态矩阵
- [[MOSA棕地与绿地对比]] — AARGM-ER棕地 vs SiAW绿地
- [[WOSA武器开放系统架构]] — WOSA武器系统架构（SiAW采用）
