...
- [[ousd-sysml-v2-transition-guidance]] — OUSD 官方过渡指导
- [[ndia-sysml-v2-transition-2023]] — NDIA 过渡指南项目简报
- [[digital-engineering-mosa-convergence]] — 数字工程与MOSA融合
- [[digital-engineering-tools-comparison]] — 数字工程工具链对比
- [[dsb-digital-engineering-2024]] — DSB数字工程报告（文化变革瓶颈）
- [[digital-engineering-practice]] — 数字工程实践（OUSD过渡时间线、SysML v2使能、NASA/INCOSE框架）
