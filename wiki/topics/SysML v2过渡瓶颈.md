...
| 指标 | 数据 | 来源 |
|------|------|------|
| DoD 政府拥有模型 | 15,000+ | [[NDIA-SysML-v2过渡指南2023]] |
| DoD 工程师使用模型比例 | 25% | [[NDIA-SysML-v2过渡指南2023]] |
| v1→v2 语法差异 | 9大类（block→part, port→port def, ...） | [[NDIA-SysML-v2过渡指南2023]] |
...
- [[NDIA-SysML-v2过渡指南2023]] — NDIA 过渡指南项目简报
