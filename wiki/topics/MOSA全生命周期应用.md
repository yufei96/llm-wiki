...
- **[[精确打击导弹MOSA案例]]**：2016 年启动，进入 MSA 阶段，MOSA 作为采办策略核心要素
- **[[XM30 MICV MOSA案例]]**：基于陆军拥有的开放标准进行 MOSA 设计
...
- **[[FLRAA-MV75 MOSA案例]]**：陆军首个数字优先飞机项目，2023年7月交付首个虚拟原型，MBSE 模型评估超过 1600 个系统属性
- **[[B-21突袭者MOSA案例]]**：B-21 在 TMRR 阶段确立 MOSA 架构，诺斯罗普·格鲁曼主导
...
- **[[SIAW与AARGM-ER模块化对比]]**：空军 SiAW 在 EMD 阶段强制实施 MOSA，海军 AARGM-ER 因短期成本放弃
...
- [[国防部MOSA实施指南2025]] — DoD MOSA实施指南
- [[国防部指令5000.85-2020]] — DoDI 5000.85 重大能力采办
- [[美国法典第10编4401-4403 MOSA法]] — MOSA法定要求
- [[AMS-GRA敏捷任务套件]] — AMS GRA（NGAD体系）
- [[A-GRA自主参考架构]] — A-GRA（自主系统）
- [[六项已验证的MOSA标准]] — 6大已验证MOSA标准
- [[数字工程生态]] — 数字工程生态系统
