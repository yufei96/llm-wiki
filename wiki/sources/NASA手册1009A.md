...
- **V&V模型化**与[[NASA手册7009A]]的M&S V&V体系互补
- **数据生成能力**（Section 9）直接服务于[[NASA手册1004]]中的MBx数据交付
...
- [[NASA手册7009A]] — NASA建模与仿真手册（M&S V&V，与本文档的V&V建模互补）
- [[NASA手册1004]] — NASA数字工程采办框架（本文档生成的MBx数据可直接用于DRD交付）
