...
| NIST原则 | MOSA对应 |
|----------|----------|
| 分层防御和分区资源 | [[模块化架构模式]] — 模块化天然实现分区 |
| 规划和管理多样性 | [[MOSA五支柱]] — 多供应商竞争 |
| 维护冗余 | [[WOSA架构工具]] — 备份接口/路径 |
| 限制信任需求 | [[网络安全与模块化开放性]] — 接口隔离降低攻击面 |
...
- [[网络安全与模块化开放性]] — 赛博安全与MOSA开放性
- [[MOSA与数字工程]] — MOSA与数字工程
- [[数字工程生态]] — 数字工程生态系统
- [[NIST网络韧性与MOSA安全]] — NIST设计原则作为MOSA安全性架构框架
- [[NASA系统工程手册修订2]] — NASA SE Handbook Rev 2（NASA的安全性工程实践）
