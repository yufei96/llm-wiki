...
- 需求质量是[[requirements-quality-mosa]]的核心——接口定义质量直接决定MOSA成败
- PPI需求分析方法论（[[ppi-requirements-analysis]]）基于此度量框架
- PM与SE整合（[[ppi-integrating-pm-se]]）中的RE投资回报论证引用此论文的TRW数据
- 完整性因子（Completeness）可为负值的特性对[[mosa-defense-acquisition]]中的需求工程有直接影响
- MIL-STD-499B（论文引用）是[[adaptive-acquisition-framework]]演化历史中的关键节点
