...
这是MITRE Corporation受PEO IWS（综合作战系统项目执行办公室）委托开发的定向能武器系统MOSA参考架构（DEWS MOSA RA）完整会议简报文档（33页），作者Keegan Merkert，发布于2023年6月Kitty Hawk Week会议。该文档是[[dews-mosa-reference-architecture]]概念页面的原始来源，提供了架构开发方法论、模块定义、数据模型、SOSA整合和数字工程交付物的全面技术细节。
...
- [[dews-mosa-reference-architecture]] — DEWS MOSA RA概念页面（将更新）
- [[mosaic-modular-open-systems-approach]] — MOSA总体方法论
- [[sosa-reference-architecture-v2]] — SOSA参考架构，DEWS整合的核心标准
