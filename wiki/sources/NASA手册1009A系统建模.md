...
- **SysML元模型**直接支持[[基于模型的系统工程]]在NASA的实施
- **NASA SE引擎对齐**确保建模活动与NPR 7123.1流程一致——这是[[NASA系统工程手册修订2]]的建模层
- **V&V模型化**与[[NASA手册7009A建模与仿真]]的M&S V&V体系互补
- **数据生成能力**（Section 9）直接服务于[[NASA手册1004数字工程采办框架]]中的MBx数据交付
- **MBSE Grid方法**为MOSA接口建模提供组织框架
- **从模型到文档**的自动化生成能力是数字工程"基于模型而非基于文档"的核心使能器
- SysML v1.7→v2过渡是[[SysML v2过渡瓶颈]]的关键影响因素

## 相关内容

- [[NASA系统工程手册修订2]] — NASA系统工程手册（SE引擎基础，本文档的SE流程对齐基础）
- [[NASA手册7009A建模与仿真]] — NASA建模与仿真手册（M&S V&V，与本文档的V&V建模互补）
- [[NASA手册1004数字工程采办框架]] — NASA数字工程采办框架（本文档生成的MBx数据可直接用于DRD交付）
- [[IEEE-NASA数字工程之旅2024]] — NASA数字工程转型历程（MBSE部署状态）
- [[数字工程生态]] — 数字工程生态系统概述
- [[数字工程实践]] — 数字工程实践
- [[基于模型的系统工程]] — 基于模型的系统工程
- [[SysML-v2规范]] — SysML-v2规范（本文档基于v1.7，v2过渡是下一步）
- [[三本系统工程手册互补]] — 三本SE手册互补
