...
- [[iso-15288-2023]] — ISO/IEC/IEEE 15288（INCOSE SEH的标准化基础）
- [[incose]] — INCOSE 组织（本手册发布者）
- [[nasa-se-handbook-rev2]] — NASA SE手册（机构特定实现）
- [[incose]] — INCOSE 组织页
...
- [[sysml-v2-specification]] — SysML v2（MBSE工具基础）
