...
- [[incose]] — INCOSE（SysML v2标准化的推动者）
- [[incose-se-handbook-v5]] — INCOSE SE Handbook V5（MBSE最佳实践）
- [[ousd-sysml-v2-transition-guidance]] — OUSD(R&E) 官方过渡指导
- [[ndia-sysml-v2-transition-2023]] — NDIA 2023 过渡指南项目简报
- [[interface-engineering-evolution]] — 接口工程三层演进
- [[sysml-v2-transition-bottleneck]] — SysML v2过渡作为MOSA数字工程瓶颈
