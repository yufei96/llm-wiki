...
## Overview (知识库总览)
- [[overview]] — MOSA与数字工程知识库总览：核心故事线、知识地图、待填补空白
...
- [[mosa-implementation-guidebook]] — 2025 DoD MOSA实施指南主题综合
...
## Sources (来源摘要)
    ...
    - [[dfars-part-252-contract-clauses]] — DFARS Part 252, Solicitation Provisions and Contract Clauses (607 pages). Data rights clauses 252.227.
    - [[hasc-report-114-102-fy2016-ndaa]] — HASC Report 114-102, FY2016 NDAA Committee Report (358 pages). Pre-MOSA acquisition reform context.
    - [[bbp-3-0-implementation-directive]] — Better Buying Power 3.0 Implementation Directive (2015, 35 pages). MOSA首次写入DoD政策。
    - [[gao-24-106831-weapon-systems]] — GAO-24-106831, 武器系统年度评估 (2024, 261 pages). MDAP/MTA绩效数据。
    - [[dodi-5000-80-middle-tier-acquisition]] — DoDI 5000.80, Middle Tier of Acquisition (2019, Chg1 2024). 19 pages. AAF快速通道路径。
    - [[cmoss-overview-2022]] — CMOSS Overview (DEVCOM C5ISR Center, 2022). 32 pages. C5ISR/EW模块化开放标准套件。
    - [[sosa-reference-architecture-v2]] — SOSA Reference Architecture Edition 1.0 V2 Snapshot (The Open Group, 2019). 214 pages. 传感器开放系统架构。
    - [[victory-ground-vehicle]] — VICTORY案例研究 (Curtiss-Wright). 车辆C4ISR/EW互操作性标准。
    - [[sosa-vita-products]] — SOSA产品技术概览 (Elma). VITA/OpenVPX硬件产品映射。
    - [[victory-gva-whitepaper]] — VICTORY/GVA地面车辆现代化白皮书 (Curtiss-Wright). VICTORY vs GVA对比。
    - [[dsp-journal-mosa-2020]] — DSP Journal MOSA专刊 (DSPO, 2020). 40 pages. MOSA/CMOSS/VICTORY/MORA/SOSA综述。
    - [[peo-aviation-mosa-industry-2022]] — PEO Aviation MOSA Industry Day 2022 (79 slides). 9条MOSA工作线+EAF框架。
    - [[peo-aviation-mosa-impl-guide]] — PEO Aviation MOSA实施指南 (2021, 23 pages). 合同模板+检查清单。
    - [[dsb-digital-engineering-2024]] — DSB数字工程报告 (2024, 66 pages). MOSA作为DEE技术基础。
    - [[mora-modular-open-rf]] — MORA模块化开放射频架构 (NDIA GVSETS 2019, 8 pages). CMOSS的RF组件标准。
    ...
    - [[ppi-integrating-pm-se]] — PPI项目管理与系统工程整合（Halligan 2018，48页）
    - [[ppi-requirements-quality-metrics]] — PPI需求质量度量体系（Halligan 1993/2017，10大因子+5过程度量，6页）
    - [[dod-de-strategy-2018]] — DoD数字工程战略（2018，5大目标，DE纲领文件）
