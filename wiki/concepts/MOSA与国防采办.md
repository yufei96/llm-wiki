...
MOSA的"出生证明"是1994年11月29日Paul G. Kaminski（时任USD(A&T)）签署的OSJTF宪章。宪章原件为4页扫描件。
...
- [[供应商锁定]] — 供应商锁定问题
- [[接口工程演进]] — 接口工程三层演进
- [[三本系统工程手册详细对比]] — 三本SE手册对比
- [[国防采办超支趋势]] — 采办项目绩效危机
- [[FACE技术标准]] — FACE航电标准（MOSA成功案例）
- [[开放任务系统]] — OMS航空任务系统标准
- [[更好购买力3.0]] — MOSA首次写入DoD政策（2015）
- [[模块化架构模式]] — 模块化架构模式
- [[中间层采办]] — MTA快速采办路径
- [[UCS控制站]] — 无人系统指挥控制标准
- [[WOSA架构工具]] — WOSA架构评估工具链
- [[PPI数据项描述模板]] — PPI DID模板（合同执行层）
- [[MOSA实施栈]] — MOSA实施全栈（五层架构）
- [[MOSA需求质量]] — 需求质量：MOSA技术基础
