...
**标准集成**：
- [[开放任务系统|OMS/UCI]] — 任务系统互操作性
- [[FACE技术标准|FACE]] — 航空电子设备可移植性
- SOSA H/W — 传感器硬件标准化
- COARPS — 雷达系统
- UAI — 武器接口
...
- [[开放架构层级]] — 开放架构四层体系（GRA横跨各层）
- [[克里斯-加勒特演讲2024]] — AFMC数字化转型演示（GRA详细描述）
- [[数字装备管理]] — DMM数字化物资管理
- [[模块化架构模式]] — 模块化架构模式
- [[MOSA与国防采办]] — MOSA核心概念
- [[MOSA五支柱]] — MOSA五大支柱
- [[FACE技术标准]] — FACE技术标准
- [[开放任务系统]] — 开放任务系统
- [[WOSA武器开放系统架构]] — WOSA武器系统架构
- [[SOSA传感器开放系统架构]] — SOSA传感器架构
- [[宿主硬件开放系统]] — HOST硬件开放系统
- [[C5ISR标准融合]] — C5ISR标准趋同
- [[六项已验证的MOSA标准]] — 六大已验证MOSA标准
- [[MIL-STD-881D国防物资工作分解结构]] — MIL-STD-881D WBS
- [[MIL-HDBK-1211导弹飞行仿真]]
...
- GRA与现有的[[六项已验证的MOSA标准|六大已验证标准]]互补——标准定义接口协议，GRA定义架构框架
