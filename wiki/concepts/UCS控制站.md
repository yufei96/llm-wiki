...
UCS是MOSA在**无人系统指控领域**的落地标准，在开放架构四层体系（[[开放架构层级]]）中位于**平台级/分系统级**，与以下标准互补：

- **[[开放任务系统]]**（OMS）— 航空任务系统接口，UCS可建立在OMS之上
- **[[SOSA传感器开放系统架构]]** — 传感器开放架构，UCS可集成SOSA兼容的传感器
- **[[Victory地面车辆]]** — 地面车辆C4ISR互操作，与UCS在UGV领域重叠
