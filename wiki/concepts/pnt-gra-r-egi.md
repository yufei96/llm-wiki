...
R-EGI位于[[open-architecture-hierarchy|开放架构四层体系]]的**第3层：设备级**，是PNT GRA的核心实现。
...
R-EGI是[[mosa-defense-acquisition|MOSA原则]]在PNT领域的典型实现：
- **模块化设计**：PNT传感器可独立替换
- **指定接口**：ASPN23消息标准化
...
R-EGI是[[government-reference-architectures|GRA体系]]在PNT领域的具体体现，与以下GRA互补：
- [[open-mission-systems|OMS]] — 任务系统总线集成
- [[sosa-sensor-open-systems-architecture|SOSA]] — 传感器硬件标准化

## 参考来源

- [[insidegnss-r-egi-milestone-2024]] — Inside GNSS报道：R-EGI关键里程碑
- [[dvids-r-egi-pnt-flight-2024]] — DVIDS报道：R-EGI与EGI-M飞行演示
- [[is4s-r-egi-c12j-flight]] — IS4S报道：C-12J飞行测试详情
- [[rntfnd-r-egi-mosa-2024]] — Resilient PNT基金会：R-EGI MOSA分析
...
*基于Inside GNSS、DVIDS、IS4S等来源综合整理。2026-05-06创建。*
