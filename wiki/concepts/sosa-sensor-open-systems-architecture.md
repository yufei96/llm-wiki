...
Chris Garrett的AFMC演示（[[chris-garrett-presentation-2024]]）显示，SOSA H/W是GRA目标架构中**几乎所有功能域的硬件基础**：
...
SOSA联盟正在通过DEWS分委员会将SOSA与定向能武器MOSA参考架构（[[dews-mosa-reference-architecture]]）整合。整合形成三类模块：
- **DEWS-SOSA通用模块**（12个）
...
- [[face-technical-standard]] — FACE定义航电软件层，SOSA定义传感器硬件层，两者互补构成MOSA双支柱
- [[open-mission-systems]] — OMS定义任务系统服务接口，建立在SOSA硬件之上
- [[host-hardware-open-systems]] — HOST是NAVAIR海军标准，SOSA是行业标准，高度互补
- [[dews-mosa-reference-architecture]] — DEWS RA正在与SOSA整合
- [[cmoss-overview-2022]] — CMOSS与SOSA高度重叠，共享底层标准
- [[mosa-defense-acquisition]] — SOSA是MOSA在传感器领域的核心落地规范
...
*基于Curtiss-Wright白皮书、Chris Garrett AFMC演示、三军联合备忘录和SOSA参考架构综合整理。2026-05-06创建。*
