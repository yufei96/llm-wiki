...
- 采用 [[FACE技术标准]] 实现软件复用和跨平台互操作
- 为与 [[FLRAA-MV75 MOSA案例]] 等未来垂直升力平台兼容奠定基础
...
根据 [[GAO-R-25-106931 MOSA审查]]，20个采办项目中**无一进行正式的MOSA成本效益分析**，因为DoD政策并未明确要求。棕地改造的前期投资通常高于绿地项目，但长期节约更为显著。GAO建议DoD开发标准化的MOSA成本效益分析方法。

## 相关内容

- [[B-21突袭者MOSA案例]] — B-21绿地新建MOSA旗舰案例
- [[太空发展局]] — SDA PWSA太空域绿地新建
- [[FLRAA-MV75 MOSA案例]] — FLRAA未来远程突击飞行器MOSA
- [[GAO-R-25-106931 MOSA审查]] — GAO MOSA专项审查报告
- [[MOSAIC方法]] — MOSA总体方法论
- [[DEWS-MOSA参考架构]] — DEWS参考架构主要面向绿地
- [[FACE技术标准]] — FACE航电软件标准（H-60M采用）
- [[供应商锁定]] — 供应商锁定问题
- [[GAO-24-106831武器系统]] — GAO武器系统报告
