...
3. **开放标准（Open Standards）**
   - 使用公开可用、共识驱动的标准
   - 促进组件复用和供应商竞争
   - 相关标准包括：[[SOSA参考架构V2]]、[[CMOSS模块化标准概述]]、[[FACE技术标准]]、OMS、MORA、UCI
...
FY2021 NDAA Sec 804授予政府模块化系统接口数据的政府目的权利（GPR）。IP Cadre提供专业建议。评估标准要求在MOSA架构中明确IP策略，但缺乏标准化评估方法论。参见 [[DoDI-5000.85重大能力收购]]。

## 相关内容

- [[GAO-MOSA专项审查报告全文]] — GAO MOSA专项审查报告（直接评估五大支柱实施状况）
- [[MOSAIC方法]] — MOSA总体方法论
