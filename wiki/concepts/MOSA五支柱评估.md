...
3. **开放标准（Open Standards）**
   - 使用公开可用、共识驱动的标准
   - 促进组件复用和供应商竞争
   - 相关标准包括：[[SOSA参考架构V2]]、[[CMOSS概述2022]]、[[FACE技术标准]]、OMS、MORA、UCI
...
根据 [[GAO-R-25-106931 MOSA审查]] 和框架本身的特点：
...
| 陆军 | 100%（6/6） | 有全面指南手册 |
| 太空军 | 75%（3/4） | 有部分指南 |
| 海军 | 50%（2/4） | 2024年发布V1.0（[[海军MOSA指南V1]]） |
...
FY2021 NDAA Sec 804授予政府模块化系统接口数据的政府目的权利（GPR）。IP Cadre提供专业建议。评估标准要求在MOSA架构中明确IP策略，但缺乏标准化评估方法论。参见 [[国防部指令5000.85-2020]]。

## 相关内容

- [[GAO-R-25-106931 MOSA审查]] — GAO MOSA专项审查报告（直接评估五大支柱实施状况）
- [[MOSAIC方法]] — MOSA总体方法论
- [[国防部指令5000.85-2020]] — DoDI 5000.85 重大能力采办
- [[MOSA实施状态矩阵]] — 20项目MOSA实施状态矩阵
- [[SIAW与AARGM-ER模块化对比]] — 军种间MOSA实施不一致的典型案例
- [[DEWS-MOSA参考架构]] — DEWS参考架构的五大愿景目标与五大支柱对应
- [[SOSA参考架构V2]] — 开放标准支柱的具体体现
- [[CMOSS概述2022]] — 开放标准支柱的具体体现
